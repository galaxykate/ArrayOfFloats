...
var utilities = {
    ...
    seedNoise : function(rnd) {
        utilities.noiseObj = new SimplexNoise(rnd);
    },
...
KColor.prototype.setTo = function(c, hueOffset) {
    hueOffset = hueOffset ? hueOffset : 0;
    this.h = c.h;
    this.s = c.s;
    this.b = c.b;
    this.a = c.a;
...
KColor.prototype.lerp = function(c0, c1, a) {
    this.h = (1 - a) * c0.h + a * c1.h;
    this.s = (1 - a) * c0.s + a * c1.s;
    this.b = (1 - a) * c0.b + a * c1.b;
    this.a = (1 - a) * c0.a + a * c1.a;
...
utilities.seedNoise(Math.random);
